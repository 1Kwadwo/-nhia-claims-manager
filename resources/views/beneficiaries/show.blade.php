    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-user me-2"></i> Beneficiary Details
            </h2>
            <div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        <tr>
                            <th width="30%">NHIS Number:</th>
                            <td><strong>{{ $beneficiary->nhis_number }}</strong></td>
                        </tr>
                        <tr>
                            <th>Full Name:</th>
                        ...
                        <tr>
                            <th>Created:</th>
                            <td>{{ $beneficiary->created_at->format('M d, Y H:i') }}</td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="card-body">
                    @if($beneficiary->claims->count() > 0)
                        <div class="row text-center">
                            <div class="col-6">
                                <h4 class="text-primary">{{ $beneficiary->claims->count() }}</h4>
                                <p class="text-muted">Total Claims</p>
                            </div>
                            <div class="col-6">
                                <h4 class="text-success">GH₵ {{ number_format($beneficiary->claims->sum('total_cost'), 2) }}</h4>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    @foreach($beneficiary->claims->take(5) as $claim)
                                        <tr>
                                            <td>
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">This beneficiary has no claims yet.</p>
                        </div>
                    @endif
                </div>
            </div>
